<template>
     <div class="bg-slate-200 basis-full overflow-y-scroll ">
    <div class="my-3 flex items-center p-3">
      <div class="h-10 w-10 rounded-full overflow-hidden">
          <img src="https://kiemtientuweb.com/ckfinder/userfiles/images/avatar-fb/avatar-fb-1.jpg" alt="avatar" class="h-full w-full">
       </div>
    ...
    <div class="my-3 flex items-center p-3">
      <div class="h-10 w-10 rounded-full overflow-hidden">
       ...
       <div class="mx-4 message_left text-black flex flex-col rounded-lg py-2 px-3">aloo
        <span class="text-xs ">20:30</span>
       </div>
    </div>
