<template>
    <div
        ...
        <div class="bg-white p-6 w-80 shadow-lg rounded-lg ">
            <h3 class="text-2xl font-bold mb-3">Edit Group</h3>
            <input type="text" value="Test  Group" class="p-3 border-b-[1px] outline-none w-full mb-3">
            ...
            <button class="bg-blue-600 text-white text-lg font-bold px-3 py-2 rounded-sm">Submit</button>
